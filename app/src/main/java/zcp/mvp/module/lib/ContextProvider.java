...
import zcp.mvp.MainActivity;
import zcp.mvp.qualifier.ApplicationContext;
import zcp.mvp.qualifier.FilesDirectory;
...
public class ContextProvider {
    ...
    public Toast provideToast() {
        return Toast.makeText(mApplicationContext, "", Toast.LENGTH_SHORT);
    }
